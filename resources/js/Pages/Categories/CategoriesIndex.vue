                              ...
                              <tr v-for="(category, index) in categories" :key="index">
                                  ...
                                  <td>
                                      <div class="d-grid d-md-flex justify-content-md-center">
                                        <router-link :to="'/CategoriesUpdate/' + category.id" class="btn btn-primary me-md-2"><font-awesome-icon icon="fa-solid fa-pen" /></router-link>
                                        <button class="btn btn-danger" @click.prevent="deleteCategory(category.id)"><font-awesome-icon icon="fa-solid fa-trash" /></button>
                                      </div>
                                  </td>
                              </tr>
                      </tbody>
